      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-brand-primary text-sm font-bold uppercase tracking-[0.2em] mb-4">About Us</h2>
            <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight tracking-tight uppercase">
              Dubai's Trusted Partner in <span className="text-brand-primary">Aviation.</span>
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div className="p-8 bg-slate-50 border-l-4 border-brand-primary rounded-r-2xl shadow-sm">
                <h4 className="font-bold text-slate-900 mb-3 uppercase tracking-widest text-xs">Our Vision</h4>
                <p className="text-sm text-slate-600 leading-relaxed font-light">Enhancing customer satisfaction by delivering practical, efficient, and dependable aviation solutions.</p>
              </div>
              <div className="p-8 bg-slate-50 border-l-4 border-slate-300 rounded-r-2xl shadow-sm">
                <h4 className="font-bold text-slate-900 mb-3 uppercase tracking-widest text-xs text-slate-500">Our Mission</h4>
                <p className="text-sm text-slate-600 leading-relaxed font-light">To uphold highest ethical standards, exceed client expectations, and pursue continuous improvement in every operation.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-brand-primary rounded-sm -z-10 flex flex-col items-center justify-center p-6 text-white text-center shadow-xl">
               ...
               <span className="text-[10px] uppercase tracking-[0.3em] mt-3 font-bold leading-tight">Years Hub Experience</span>
            </div>
        ...
        <div className="mt-40">
          <div className="text-center mb-20">
            <h3 className="text-brand-primary text-xs font-black uppercase tracking-[0.5em] mb-4">Values</h3>
            <h4 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Foundation of Excellence.</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {VALUES.map((value) => (
              <div key={value.title} className="p-10 border border-slate-100 rounded-sm hover:shadow-2xl transition-all bg-white group text-center">
                ...
                <h4 className="font-black text-slate-900 mb-4 uppercase tracking-tighter text-lg">{value.title}</h4>
                <p className="text-xs text-slate-500 leading-relaxed font-medium uppercase tracking-widest">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
