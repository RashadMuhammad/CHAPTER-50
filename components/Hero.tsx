...
const Hero: React.FC = () => {
  return (
    <section
      id="home"
      className="relative min-h-[95vh] flex items-center overflow-hidden bg-brand-secondary"
    >
      ...
      <div className="container mx-auto px-6 relative z-20 pt-24 sm:pt-0">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-white/70 mb-12 leading-relaxed font-light max-w-2xl border-l-2 border-white/20 pl-8">
            Superior cargo handling and airside supervision in Dubai. Over 25
            years of field-proven expertise at your service.
          </p>

          <div className="flex flex-col sm:flex-row gap-6">
            <button
              onClick={() => scrollToSection("services")}
              className="px-12 py-5 bg-white text-brand-secondary font-black rounded-sm shadow-2xl hover:bg-blue-50 transition-all text-center flex items-center justify-center group uppercase tracking-widest text-xs"
            >
              Our Services
              <svg
            ...
            <button
              ...
              className="px-12 py-5 bg-transparent border border-white/30 text-white font-black rounded-sm hover:bg-white/10 transition-all text-center backdrop-blur-sm uppercase tracking-widest text-xs"
            >
              Contact Experts
            </button>
          </div>
