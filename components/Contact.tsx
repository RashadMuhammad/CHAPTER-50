      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/2">
            <h2 className="text-blue-900 text-sm font-bold uppercase tracking-[0.2em] mb-4">
              Contact
            </h2>
            ...
            <div className="mt-8 p-8 bg-slate-900 rounded-3xl text-white relative overflow-hidden group">
              <div className="relative z-10">
                <h4 className="text-xl font-bold mb-4">
                  Looking for a tailored solution?
                </h4>
                <p className="text-slate-400 mb-3 text-sm">
                  No matter the size or complexity of your cargo, our team works
                  diligently to provide the best solution and guarantee timely
                  delivery.
                </p>
                {/* <button className="px-6 py-3 bg-blue-600 rounded-lg font-bold text-sm hover:bg-blue-700 transition-colors">
                  Request a Quote
                </button> */}
              </div>
              <svg
                className="absolute -bottom-10 -right-10 w-48 h-48 text-white/5 group-hover:text-white/10 transition-all duration-500 transform group-hover:rotate-12"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path d="M10 50 L40 50 L45 35 L55 35 L60 50 L90 50 L90 55 L60 55 L55 70 L45 70 L40 55 L10 55 Z" />
              </svg>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <form
              ref={formRef}
              onSubmit={sendEmail}
              className="bg-slate-50 p-10 rounded-3xl border border-slate-100 shadow-xl"
            >
              ...
              <div className="mb-8">
                ...
                <textarea
                  name="message"
                  rows={5}
                  placeholder="Tell us about your cargo needs..."
